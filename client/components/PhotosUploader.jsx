          ...
          addedPhotos.map((link, i) => (
            ...
            >
              ...
              <button
                ...
                className="absolute bottom-1 right-1 rounded-2xl bg-black bg-opacity-50 py-2 px-3 text-white"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 rounded-2xl bg-black bg-opacity-50 py-2 px-3 text-white"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
